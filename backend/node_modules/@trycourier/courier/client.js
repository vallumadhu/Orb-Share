...
var _Courier_instances, _a, _Courier_encoder, _Courier_baseURLOverridden;
...
const audiences_1 = require("./resources/audiences.js");
...
const bulk_1 = require("./resources/bulk.js");
const inbound_1 = require("./resources/inbound.js");
const messages_1 = require("./resources/messages.js");
const requests_1 = require("./resources/requests.js");
const send_1 = require("./resources/send.js");
const translations_1 = require("./resources/translations.js");
const automations_1 = require("./resources/automations/automations.js");
const lists_1 = require("./resources/lists/lists.js");
const notifications_1 = require("./resources/notifications/notifications.js");
const profiles_1 = require("./resources/profiles/profiles.js");
const tenants_1 = require("./resources/tenants/tenants.js");
...
class Courier {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('COURIER_BASE_URL'), apiKey = (0, env_1.readEnv)('COURIER_API_KEY'), ...opts } = {}) {
        _Courier_instances.add(this);
        _Courier_encoder.set(this, void 0);
        this.send = new API.Send(this);
        this.audiences = new API.Audiences(this);
        this.auditEvents = new API.AuditEvents(this);
        this.auth = new API.Auth(this);
        this.automations = new API.Automations(this);
        this.brands = new API.Brands(this);
        this.bulk = new API.Bulk(this);
        this.inbound = new API.Inbound(this);
        this.lists = new API.Lists(this);
        this.messages = new API.Messages(this);
        this.requests = new API.Requests(this);
        this.notifications = new API.Notifications(this);
        this.profiles = new API.Profiles(this);
        this.tenants = new API.Tenants(this);
        this.translations = new API.Translations(this);
        this.users = new API.Users(this);
        if (apiKey === undefined) {
            throw new Errors.CourierError("The COURIER_API_KEY environment variable is missing or empty; either provide it, or instantiate the Courier client with an apiKey option, like new Courier({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            ...opts,
            baseURL: baseURL || `https://api.courier.com`,
        };
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('COURIER_LOG'), "process.env['COURIER_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Courier_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Courier_instances, "m", _Courier_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Courier_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Courier = Courier;
_a = Courier, _Courier_encoder = new WeakMap(), _Courier_instances = new WeakSet(), _Courier_baseURLOverridden = function _Courier_baseURLOverridden() {
    return this.baseURL !== 'https://api.courier.com';
};
Courier.Courier = _a;
Courier.DEFAULT_TIMEOUT = 60000; // 1 minute
Courier.CourierError = Errors.CourierError;
Courier.APIError = Errors.APIError;
Courier.APIConnectionError = Errors.APIConnectionError;
Courier.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Courier.APIUserAbortError = Errors.APIUserAbortError;
Courier.NotFoundError = Errors.NotFoundError;
Courier.ConflictError = Errors.ConflictError;
Courier.RateLimitError = Errors.RateLimitError;
Courier.BadRequestError = Errors.BadRequestError;
Courier.AuthenticationError = Errors.AuthenticationError;
Courier.InternalServerError = Errors.InternalServerError;
Courier.PermissionDeniedError = Errors.PermissionDeniedError;
Courier.UnprocessableEntityError = Errors.UnprocessableEntityError;
Courier.toFile = Uploads.toFile;
Courier.Send = send_1.Send;
Courier.Audiences = audiences_1.Audiences;
Courier.AuditEvents = audit_events_1.AuditEvents;
Courier.Auth = auth_1.Auth;
Courier.Automations = automations_1.Automations;
Courier.Brands = brands_1.Brands;
Courier.Bulk = bulk_1.Bulk;
Courier.Inbound = inbound_1.Inbound;
Courier.Lists = lists_1.Lists;
Courier.Messages = messages_1.Messages;
Courier.Requests = requests_1.Requests;
Courier.Notifications = notifications_1.Notifications;
Courier.Profiles = profiles_1.Profiles;
Courier.Tenants = tenants_1.Tenants;
Courier.Translations = translations_1.Translations;
Courier.Users = users_1.Users;
