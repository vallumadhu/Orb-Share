...
import { TemplateListParams, TemplateListResponse, TemplateRetrieveParams, Templates } from "./templates.mjs";
import * as PreferencesAPI from "./preferences/preferences.mjs";
import { Preferences } from "./preferences/preferences.mjs";
...
export declare namespace DefaultPreferences {
    interface Item extends TenantsAPI.SubscriptionTopicNew {
        /**
         * Topic ID
         */
        id: string;
